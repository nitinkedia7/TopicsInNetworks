...
public class Airport implements Runnable {
    ...
    public void printTheoreticalValue() {
        ...
        double responseTime = 1.0 / (serviceMeanRate - arrivalMeanRatefor1queue);
        double waitTime = responseTime - (1.0 / serviceMeanRate);
        double numberOfPassengerInSystem = 3 * arrivalMeanRatefor1queue * responseTime;
        double numberOfPassengersWaiting = 3 * arrivalMeanRatefor1queue * waitTime;
    ...
    public void printStatistics() {
        ...
        for (int i = 0; i < stopTime; i++) {
            ...
            waitingPassenger += (stat.noOfWaitingPassengersOfficer1 + stat.noOfWaitingPassengersOfficer2
                    + stat.noOfWaitingPassengersOfficer3);
            gettingInspectedPassenger += stat.noOfPassengersInSystem - (stat.noOfWaitingPassengersOfficer1
                    + stat.noOfWaitingPassengersOfficer2 + stat.noOfWaitingPassengersOfficer3);
